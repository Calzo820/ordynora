...
const translations = {
  ...
  en: {
    ...
    easyTitle: "Ordynora", easyCopy: "Fewer errors, more clarity, an organised menu and one operational workflow.",
  ...
  de: {
    ...
    classicTitle: "Klassisches digitales Menü", classicCopy: "QR-Code, Online-PDF, Menüänderungen und grundlegende Statistiken.", easyTitle: "Ordynora", easyCopy: "Weniger Fehler, mehr Klarheit, ein geordnetes Menü und ein gemeinsamer Betriebsablauf.",
  ...
  es: {
    ...
    classicTitle: "Menú digital clásico", classicCopy: "QR, PDF online, cambios de menú y estadísticas básicas.", easyTitle: "Ordynora", easyCopy: "Menos errores, más claridad, menú ordenado y un único flujo operativo.",
  ...
  ru: {
    ...
    classicTitle: "Обычное цифровое меню", classicCopy: "QR-код, PDF онлайн, изменение меню и базовая статистика.", easyTitle: "Ordynora", easyCopy: "Меньше ошибок, больше ясности, аккуратное меню и единый рабочий процесс.",
